    ...
    if (Object.keys(errors).length === 0) {
      try {
        ...
        if (response.ok) {
          ...
          history.push(
            `/PaymentPlan?customerId=${encodeURIComponent(customerId)}`
          );
        } else {
          const responseData = await response.json();
    ...
    <div className="container">
      ...
      <div className="inputs">
        <div className="input">
          ...
          />
          {errors.username && (
            <div className="error-signup">{errors.username}</div>
          )}
        </div>
        <div className="input">
          <label htmlFor="email">
        ...
        <div className="mx-auto">
          ...
          />
          <label htmlFor="terms" className="check-term">
            I agree to the{" "}
            <Link
              to="/TermsOfService"
          ...
          {errors.terms && <div className="error-signup">{errors.terms}</div>}
        </div>
      </div>
      <div className="submitContainer mt-3">
