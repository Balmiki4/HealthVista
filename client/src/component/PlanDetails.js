      ...
      {planData.map((plan, index) => (
        <div key={index}>
          ...
          <ul>
            ...
            <li>
              Clinical Quality Management Rating:{" "}
              {plan.quality_rating.clinical_quality_management_rating > 0
                ? plan.quality_rating.clinical_quality_management_rating
                : "Rating not available"}
            </li>
            <li>
              Enrollee Experience Rating:{" "}
              {plan.quality_rating.enrollee_experience_rating > 0
                ? plan.quality_rating.enrollee_experience_rating
                : "Rating not available"}
            </li>
            <li>
              Plan Efficiency Rating:{" "}
              {plan.quality_rating.plan_efficiency_rating > 0
                ? plan.quality_rating.plan_efficiency_rating
                : "Rating not available"}
            </li>
          </ul>
          <p>
