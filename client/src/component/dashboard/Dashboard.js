          ...
          <div class="col-md-4 col-xs-12 col-sm-4 col-lg-4 mb-4">
            <div class="feature-main">
              ...
              <div class="feature-head">
                ...
                <p>Stay on Top of Your Medications: Track Dosages with Ease.</p>
                <Link to="/medication">
          ...
          <div class="col-md-4 col-xs-12 col-sm-4 col-lg-4">
            <div class="feature-main">
              ...
              <div class="feature-head">
                ...
                <p>
                  Easily Monitor Your Daily Nutrition and Calorie Intake for a
                  Healthier You.
                </p>
                <Link to="/Nutrition">
                  <button class="btn btn-outline-success feature-learn-now-btn ">
          ...
          <div class="col-md-4 col-xs-12 col-sm-4 col-lg-4 mb-4">
            <div class="feature-main">
              ...
              <div class="feature-head">
                ...
                <p>
                  Locate the Nearest Hospital for All Medical Needs, Emergency
                  or Not.
                </p>
                <Link to="/map">
                  <button class="btn btn-outline-success feature-learn-now-btn ">
          ...
          <div class="col-md-4 col-xs-12 col-sm-4 col-lg-4">
            <div class="feature-main">
              ...
              <div class="feature-head">
                ...
                <p>
                  Unlock Insights to Wellness: Dive into Engaging Health
                  Articles for Your Journey.
                </p>
                <Link to="/article">
                  <button class="btn btn-outline-success feature-learn-now-btn ">
                    Health article
          ...
          <div class="col-md-4 col-xs-12 col-sm-4 col-lg-4">
            <div class="feature-main">
              ...
              <div class="feature-head">
                ...
                <p>
                  Elevate Your Fitness: Access a Variety of Engaging Exercise
                  Videos for Every Goal.
                </p>
          ...
          <div class="col-md-4 col-xs-12 col-sm-4 col-lg-4">
            <div class="feature-main">
              ...
              <div class="feature-head">
                ...
                <p>
                  Discover Tailored Coverage: Our Insurance Recommender Finds
                  the Perfect Plan.
                </p>
